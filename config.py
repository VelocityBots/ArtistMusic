...
class Config:
    def __init__(self):
        ...
        # ArtistBots API
        self.ARTISTBOTS_API_URL: str = getenv("ARTISTBOTS_API_URL", "https://artistbots.onrender.com")
        self.ARTISTBOTS_KEY: str = getenv("ARTISTBOTS_KEY", "ArtistbotsRCKCGMUkTH0CBRvLot63pr")
